...
public abstract class PSVarargs
{
    ...
    static final class PairVarargs extends PSVarargs
    {
        ...
        public PairVarargs(PSValue self, PSVarargs rest)
        {
            this.self = self;
            this.rest = rest;
        }
        ...
        {
            return index == 0 ? self : rest.arg(index - 1);
        }
    ...
    static final class ArrayVarargs extends PSVarargs
    {
        ...
        public ArrayVarargs(PSValue self, PSValue arg1, PSVarargs rest)
        {
            this.args = new PSValue[] { self, arg1 };
            this.rest = rest;
        }
