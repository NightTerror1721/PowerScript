...
public final class PSArray extends PSValue implements Iterable<PSValue>
{
    ...
    @Override
    public final PSDataType getPSDataType() { return PSDataType.ARRAY; }
    ...
    @Override
    public int resultElementsCount() { return array.size(); }
    
    @Override
    public PSValue resultElement(int index)
    {
        return index < 0 || index >= array.size() ? UNDEFINED : array.get(index);
    }
